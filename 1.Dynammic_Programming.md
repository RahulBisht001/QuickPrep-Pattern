   ...
   2. `--- DP on Subsequence ---`
      ...
      ` *Note: These Two are Very Imp 👆🏻* `
       ...
       2. `< Longest Increasing Subsequence >`
           ...
           3.  [Maximum sum of elements not part of LIS](https://www.geeksforgeeks.org/problems/maximum-sum-of-elements-not-part-of-lis/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card)
           4.  
